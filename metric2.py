...
for i in range(50):
    G = nx.read_gml('networks/biological_group/biological-3-' + str(i) + '.gml')
    Gt, Gp = sample(G, 0.9)
    print (i, len(Gt), len(Gp), len(Gt.edges()), len(Gp.edges()))

    pickle.dump(Gt, open('networks/biological_group/human_train' + str(i) + '.gml', 'wb'))
    pickle.dump(Gp, open('networks/biological_group/human_test' + str(i) + '.gml', 'wb'))
